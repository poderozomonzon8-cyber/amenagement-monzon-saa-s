    ...
    <>
      ...
      <section className="relative min-h-[92vh] flex flex-col justify-center bg-black px-6 lg:px-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-20">
          {/* Eyebrow */}
          <p className="text-xs tracking-[0.25em] uppercase mb-8 font-sans" style={{ color: accentColor }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              ...
              className="inline-flex items-center gap-2 hover:opacity-90 text-black font-semibold px-8 py-4 text-sm tracking-wide transition-colors"
      ...
      {/* Stats bar */}
      <section className="py-8 px-6" style={{ backgroundColor: accentColor }}>
      ...
      <section className="bg-black py-28 px-6 lg:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
            <div>
              <p className="text-xs tracking-[0.2em] uppercase mb-3" style={{ color: accentColor }}>What We Do</p>
      ...
      <section className="bg-[#0a0a0a] border-y border-white/10 py-28 px-6 lg:px-16">
        <div className="max-w-7xl mx-auto">
          <p className="text-xs tracking-[0.2em] uppercase mb-3" style={{ color: accentColor }}>Why Monzon</p>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {reasons.map((reason) => (
              <div key={reason.label}>
                <reason.icon className="w-6 h-6 mb-5" style={{ color: accentColor }} />
      ...
      <section className="bg-black py-28 px-6 lg:px-16">
        <div className="max-w-7xl mx-auto">
          <p className="text-xs tracking-[0.2em] uppercase mb-3" style={{ color: accentColor }}>Client Testimonials</p>
          <h2 className="font-serif text-4xl md:text-5xl text-white mb-16 text-balance">What our clients say.</h2>

          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.slice(0, 3).map((t, i) => (
              <div key={i} className="border border-white/10 p-8 flex flex-col gap-6">
