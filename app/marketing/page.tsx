...
export default function MarketingHome() {
  return (
    <>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {/* Hardscape & Landscape */}
            <div className="group bg-gradient-to-br from-white/5 to-white/0 border border-white/10 rounded-xl p-8 hover:border-green-600/50 transition">
            ...
            {/* Maintenance */}
            <div className="group bg-gradient-to-br from-white/5 to-white/0 border border-white/10 rounded-xl p-8 hover:border-blue-600/50 transition">
      ...
      {/* CTA Section */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-yellow-600/10 to-yellow-600/5 border-y border-yellow-600/20">
