    ...
    <>
      ...
      <section className="bg-black px-4 sm:px-6 lg:px-16 pt-16 sm:pt-24 pb-10 sm:pb-16 border-b border-white/10">
        <div className="max-w-7xl mx-auto">
          <p className="text-[#C9A84C] text-xs tracking-[0.25em] uppercase mb-3 sm:mb-4">Contact</p>
          ...
          {step === 'form' ? (
            <div className="grid md:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
              ...
              <div className="flex flex-col gap-8 sm:gap-10">
                <div>
                  <p className="text-[#C9A84C] text-xs tracking-[0.2em] uppercase mb-4 sm:mb-6">Get In Touch</p>
                ...
                <div className="border border-white/10 p-4 sm:p-6">
                  <p className="text-white text-sm font-medium mb-2 sm:mb-3">Business Hours</p>
              ...
              <div className="md:col-span-2 border border-white/10 p-6 sm:p-8">
                <form onSubmit={handleSubmit} className="flex flex-col gap-5 sm:gap-6">
                  <p className="text-[#C9A84C] text-xs tracking-[0.2em] uppercase mb-1 sm:mb-2">Get Your Free Quote</p>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="border border-white/10 p-8 sm:p-12 text-center">
                ...
                <h2 className="font-serif text-2xl sm:text-3xl text-white mb-3 sm:mb-4">Thank You!</h2>
                <p className="text-gray-400 text-sm sm:text-base mb-6 sm:mb-8">Your quote request has been received. Our team will review your project details and contact you within one business day with a detailed estimate and next steps.</p>
