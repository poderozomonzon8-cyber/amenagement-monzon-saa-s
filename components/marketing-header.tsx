        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex gap-4 items-center">
            ...
            <div className="flex items-center gap-3 border-r border-white/10 pr-4">
              <a
                href="https://www.facebook.com/people/Am%C3%A9nagement-Monzon/100090795267611/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/amenagement_monzon"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.tiktok.com/@amenagement_monzon"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="text-gray-400 hover:text-white transition-colors"
          ...
          <div className="md:hidden pb-6 space-y-4 animate-in fade-in duration-200">
            ...
            <div className="pt-4 space-y-3">
              ...
              <div className="flex items-center gap-4 pt-2">
                <a href="https://www.facebook.com/people/Am%C3%A9nagement-Monzon/100090795267611/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-400 hover:text-white transition-colors">
                ...
                <a href="https://www.instagram.com/amenagement_monzon" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 hover:text-white transition-colors">
                ...
                <a href="https://www.tiktok.com/@amenagement_monzon" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-gray-400 hover:text-white transition-colors">
